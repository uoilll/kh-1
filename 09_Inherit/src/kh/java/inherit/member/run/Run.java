package kh.java.inherit.member.run;

import kh.java.inherit.member.controller.MemberManager;
import kh.java.inherit.member.vo.Gold;
import kh.java.inherit.member.vo.Silver;
import kh.java.inherit.member.vo.VVip;
import kh.java.inherit.member.vo.Vip;
